...
class Cliente(Base):
    ...
    xml_mapping_config = Column(JSON)  # Configuração do mapeamento XML
    
    # Configurações de importação
    importacao_ativa = Column(Boolean, default=True)
    frequencia_importacao = Column(String(50), default='diaria')  # diaria, semanal, manual
    ...
    # Status
    status = Column(String(50), default='ativo')  # ativo, inativo, suspenso
    plano = Column(String(50), default='basico')  # basico, premium, enterprise
